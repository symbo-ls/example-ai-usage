          ...
          },
          {
            ...
            Field: {
              Input: {
                ...
                value: (el, s) => {
                  try {
                    const channels = s.communication_channels ? JSON.parse(s.communication_channels)[0] : {}
                    return channels['Slack-Tech'] || ''
                  } catch (e) { return '' }
                }
              },
            },
            ...
            Field: {
              Input: {
                ...
                value: (el, s) => {
                  try {
                    const channels = s.communication_channels ? JSON.parse(s.communication_channels)[0] : {}
                    return channels['Telegram-Tech'] || channels['Telegram'] || ''
                  } catch (e) { return '' }
                }
              },
            },
