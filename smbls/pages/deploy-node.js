          ...
          RadioGroup: {
            ...
            Latitude: {
              ...
              Span: {
                text: "Latitude.sh",
                fontWeight: (el, s) =>
                  s.cloud_provider === "Latitude" ? "600" : "400",
              },
              input: {
                tag: "input",
                type: "radio",
          ...
          Select: {
            ...
            Selects: {
              ...
              children: [
                ...
                {
                  text: "e2-standard-4 (4 vCPU, 16GB)",
                  value: "e2-standard-4",
                },
                {
                  text: "e2-standard-8 (8 vCPU, 32GB)",
                  value: "e2-standard-8",
                },
                {
                  text: "n2-standard-8 (8 vCPU, 32GB)",
                  value: "n2-standard-8",
                },
                {
                  text: "n2-standard-16 (16 vCPU, 64GB)",
          ...
          Select: {
            ...
            Selects: {
              ...
              children: [
                ...
                {
                  text: "c3.medium.x86 (16 cores, 64GB)",
                  value: "c3.medium.x86",
                },
                {
                  text: "c3.large.x86 (32 cores, 128GB)",
                  value: "c3.large.x86",
                },
              ],
              childProps: {
