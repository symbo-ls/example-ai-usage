export const Row = {
  scope: {
    filterByEnv: function filterByEnv(array, value) {
      return (
        this.call("isArray", array) &&
        array.filter((item) => item.env === value).length
      );
    },
  },
  Flex: {
    ...
    Mainnet: {
      ...
      fontSize: "Z2",
      hide: (el, s) =>
        !el.scope.filterByEnv(s.validator_info, "Mainnet") &&
        !el.scope.filterByEnv(s.rpc_info, "Mainnet"),
      order: 12,
    },
    Testnet: {
      extends: "NetworkRowLabel",
      ...
      fontSize: "Z2",
      hide: (el, s) =>
        !el.scope.filterByEnv(s.validator_info, "Testnet") &&
        !el.scope.filterByEnv(s.rpc_info, "Testnet"),
      order: 12,
    },
    gap: "B",
    align: "center",
